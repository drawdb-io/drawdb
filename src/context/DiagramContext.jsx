...
export default function DiagramContextProvider({ children }) {
  ...
  const addTable = useCallback(
    ...
    [transform.pan, database, tables.length, setUndoStack, setRedoStack, t],
  );
  ...
  const deleteField = useCallback(
    ...
    [tables, relationships, setUndoStack, setRedoStack, updateTable, t],
  );
  ...
  const addRelationship = useCallback(
    ...
    [relationships.length, setUndoStack, setRedoStack, t],
  );
  ...
  const deleteRelationship = useCallback(
    ...
    [relationships, setUndoStack, setRedoStack, t],
  );
