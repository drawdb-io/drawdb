...
export function calcPath(r, zoom = 1, showComments = true) {
  ...
  const startWidth = (r.startTable.width || 200) * zoom;
  const endWidth = (r.endTable.width || 200) * zoom;
  ...
  let y2 =
    ...
    getCommentHeight(r.endTable.comment, r.endTable.width || 200, showComments) +
    tableHeaderHeight +
    tableFieldHeight / 2;
