...
const fr = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "La colonne '{{fieldName}}' de la table '{{tableName}}' avec une définition héritée sera fusionnée",
    ...
    open: "Ouvrir",
    open_recent: "Ouvrir les récents",
    save: "Enregistrer",
    ...
    generic: "Générique",
    generic_description:
      "Les diagrammes génériques peuvent être exportés dans n'importe quel langage SQL mais supportent peu de types de données.",
    enums: "Énumérations",
    add_enum: "Ajouter une énumération",
    edit_enum: "{{extra}} Modifier l'énumération {{enumName}}",
    delete_enum: "Supprimer l'énumération",
    enum_w_no_name: "Enumération sans nom trouvée",
    enum_w_no_values: "Enumération '{{enumName}}' sans valeurs trouvée",
    ...
    share_info:
      "* Le partage de ce lien ne créera pas de session de collaboration en temps réel.",
    ...
    label: "Étiquette",
    many_side_label: "Étiquette du côté 'plusieurs(n)'",
    version: "Version",
    versions: "Versions",
    ...
    restore_warning:
      "Le chargement d'une autre version écrasera toutes les modifications.",
    return_to_current: "Retourner au diagramme",
    ...
    generate_migration: "Générer la migration",
    migration_not_supported_generic:
      "Les migrations ne sont pas supportées pour les diagrammes génériques.",
    no_migration_needed: "Aucune migration nécessaire",
    scripts: "Scripts",
    json_diff: "Différence JSON",
    ...
    custom_types_description:
      "Définissez des types de données personnalisés non supportés par défaut. Ces types seront disponibles lors de la création ou de l'édition de colonnes.",
    type_data_corrupted: "Les types configurés sont corrompus.",
    no_custom_types: "Vous n'avez aucun type configuré",
    close: "Fermer",
