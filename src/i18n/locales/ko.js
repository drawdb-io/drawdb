...
const ko = {
  translation: {
    ...
    // Added from Malay translations for parity—please provide correct Korean translation!
    open_recent: "최근 열기",
    ...
    copy_link: "링크 복사",
    readme: "README",
    failed_to_load: "로드에 실패했습니다. 링크를 확인하세요.",
    share_info: "* 이 링크를 공유해도 실시간 협업 세션이 만들어지지 않습니다.",
    show_relationship_labels: "관계 라벨 표시",
    docs: "문서",
    supported_types: "지원되는 파일 유형:",
    bulk_update: "일괄 업데이트",
    multiselect: "다중 선택",
    ...
    tab_view: "탭 보기",
    label: "라벨",
    many_side_label: "다수측 라벨 (n)",
    version: "버전",
    versions: "버전",
    no_saved_versions: "저장된 버전 없음",
    record_version: "버전 기록",
    commited_at: "커밋 시각",
    read_only: "읽기 전용",
    continue: "계속",
    restore_version: "버전 복원",
    restore_warning: "다른 버전을 불러오면 모든 변경 사항이 덮어써집니다.",
    return_to_current: "현재 다이어그램으로 돌아가기",
    no_changes_to_record: "기록할 변경 사항이 없습니다.",
    click_to_view: "클릭하여 보기",
    load_more: "더 불러오기",
    clear_cache: "캐시 비우기",
    cache_cleared: "캐시가 비워졌습니다",
    failed_to_record_version: "버전 기록 실패",
    failed_to_load_diagram: "다이어그램 로딩 실패",
    see_all: "모두 보기",
    insert_sql: "SQL 삽입",
    upload_file: "파일 업로드",
