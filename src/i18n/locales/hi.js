...
const hi = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "टेबल '{{tableName}}' में कॉलम '{{fieldName}}' जिसमें इनहेरिटेड परिभाषा है, उसे मर्ज किया जाएगा",
    nullable: "न्यूलेबल",
    snap_to_grid: "ग्रिड पर स्नैप करें",
    show_datatype: "डेटा प्रकार दिखाएं",
    show_debug_coordinates: "डीबग निर्देशांक दिखाएं",
    show_relationship_labels: "सम्बन्ध लेबल दिखाएं",
    show_comments: "टिप्पणियाँ दिखाएं",
    transform: "ट्रांसफ़ॉर्म",
    viewbox: "व्यूबॉक्स",
    cursor_coordinates: "कर्सर निर्देशांक",
    coordinate_space: "स्थान",
    coordinate_space_screen: "स्क्रीन",
    coordinate_space_diagram: "डायग्राम",
    pick_db: "डेटाबेस चुनें",
    generic: "जेनेरिक",
    generic_description:
      "जेनेरिक डायग्राम किसी भी SQL फ्लेवर में एक्सपोर्ट किए जा सकते हैं लेकिन कम डेटा प्रकारों का समर्थन करते हैं।",
    enums: "एनम",
    add_enum: "एनम जोड़ें",
    edit_enum: "{{extra}} एनम {{enumName}} एडिट करें",
    delete_enum: "एनम हटाएं",
    enum_w_no_name: "बिना नाम वाला एनम मिला",
    enum_w_no_values: "एनम '{{enumName}}' बिना वैल्यू के मिला",
    duplicate_enums: "नाम '{{enumName}}' वाले डुप्लिकेट एनम",
    enum_deleted: "एनम हटाया गया",
    no_enums: "कोई एनम नहीं",
    no_enums_text: "एनम यहाँ परिभाषित करें",
    declare_array: "ऐरे घोषित करें",
    empty_index_name:
      "टेबल '{{tableName}}' में बिना नाम के इंडेक्स घोषित किया",
    unsigned: "अनसाइन्ड",
    share: "शेयर करें",
    unshare: "अनशेयर",
    ...
    share_info:
      "* इस लिंक को शेयर करने से लाइव रियल-टाइम सहयोग सत्र नहीं बनेगा।",
    docs: "डॉक्स",
    supported_types: "समर्थित फ़ाइल प्रकार:",
    bulk_update: "बल्क अपडेट",
    multiselect: "मल्टीसेलेक्ट",
    export_saved_data: "सेव डेटा एक्सपोर्ट करें",
    dbml_view: "DBML व्यू",
    tab_view: "टैब व्यू",
    label: "लेबल",
    ...
    commited_at: "कमिट किया",
    read_only: "केवल पढ़ें",
    continue: "जारी रखें",
    restore_version: "संस्करण पुनर्स्थापित करें",
    restore_warning:
      "दूसरा संस्करण लोड करने से सभी बदलाव अधिलेखित हो जाएंगे।",
    return_to_current: "डायग्राम पर वापस",
    ...
    migration_not_supported_generic:
      "जेनेरिक डायग्राम के लिए माइग्रेशन समर्थित नहीं है।",
    no_migration_needed: "कोई माइग्रेशन की जरूरत नहीं",
    scripts: "स्क्रिप्ट",
    json_diff: "JSON अंतर",
    download: "डाउनलोड",
    insert_sql: "SQL इन्सर्ट करें",
