...
const hi = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "टेबल '{{tableName}}' में इनहेरिटेड डेफिनिशन वाला कॉलम '{{fieldName}}' मर्ज किया जाएगा",
    import_from: "से इम्पोर्ट करें",
    file: "फ़ाइल",
    new: "नया",
    new_window: "नई विंडो",
    open: "खोलें",
    ...
    autosave: "ऑटोसेव",
    panning: "पैनिंग",
    show_debug_coordinates: "डीबग कोऑर्डिनेट्स दिखाएं",
    transform: "ट्रांसफॉर्म",
    viewbox: "व्यू बॉक्स",
    cursor_coordinates: "कर्सर कोऑर्डिनेट्स",
    ...
    generic: "जेनेरिक",
    generic_description:
      "जेनेरिक डायग्राम किसी भी SQL फ्लेवर में एक्सपोर्ट किए जा सकते हैं लेकिन कम डेटा टाइप्स सपोर्ट करते हैं।",
    enums: "एनम्स",
    add_enum: "एनम जोड़ें",
    edit_enum: "{{extra}} एनम एडिट करें {{enumName}}",
    delete_enum: "एनम हटाएं",
    enum_w_no_name: "बिना नाम का एनम मिला",
    enum_w_no_values: "एनम '{{enumName}}' में कोई वैल्यू नहीं मिली",
    ...
    unsigned: "अनसाइंड",
    share: "शेयर करें",
    unshare: "शेयर बंद करें",
    copy_link: "लिंक कॉपी करें",
    readme: "रीडमी",
    failed_to_load: "लोड करने में विफल। सुनिश्चित करें कि लिंक सही है।",
    share_info:
      "* इस लिंक को शेयर करने से लाइव रियल-टाइम कोलैबोरेशन सेशन नहीं बनेगा।",
