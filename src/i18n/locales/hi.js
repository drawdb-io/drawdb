...
const hi = {
  translation: {
    ...
    merging_column_w_inherited_definition:
      "टेबल '{{tableName}}' में इनहेरिटेड परिभाषा वाले कॉलम '{{fieldName}}' को मर्ज किया जाएगा",
    snap_to_grid: "ग्रिड पर स्नैप करें",
    show_datatype: "डेटाटाइप दिखाएं",
    show_debug_coordinates: "डिबग निर्देशांक दिखाएं",
    ...
    generic: "जेनेरिक",
    generic_description:
      "जेनेरिक डायग्राम को किसी भी SQL फ्लेवर में एक्सपोर्ट किया जा सकता है लेकिन कुछ डेटा प्रकारों का समर्थन करता है।",
    enums: "Enums",
    add_enum: "Enum जोड़ें",
    edit_enum: "{{extra}} Enum एडिट करें {{enumName}}",
    delete_enum: "Enum हटाएं",
    enum_w_no_name: "बिना नाम के Enum पाया गया",
    enum_w_no_values: "बिना मानों के Enum '{{enumName}}' पाया गया",
    duplicate_enums: "नाम '{{enumName}}' वाले डुप्लिकेट Enums",
    enum_deleted: "Enum हटाया गया",
    no_enums: "कोई Enums नहीं",
    no_enums_text: "यहाँ Enums परिभाषित करें",
    declare_array: "Array घोषित करें",
    empty_index_name: "टेबल '{{tableName}}' में बिना नाम के इंडेक्स घोषित किया",
    unsigned: "Unsigned",
    share: "शेयर",
    unshare: "अनशेयर",
    ...
    share_info:
      "* इस लिंक को शेयर करने से लाइव रीयल-टाइम सहयोग सत्र नहीं बनेगा।",
