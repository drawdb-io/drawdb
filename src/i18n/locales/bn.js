...
const bn = {
  translation: {
    ...
    db_mysql_description: "MySQL একটি ওপেন-সোর্স রিলেশনাল ডাটাবেস ম্যানেজমেন্ট সিস্টেম।",
    db_postgresql_description: "PostgreSQL একটি শক্তিশালী, ওপেন-সোর্স অবজেক্ট-রিলেশনাল ডাটাবেস সিস্টেম।",
    db_sqlite_description: "SQLite একটি C-ভাষার লাইব্রেরি যা একটি ছোট, দ্রুত, স্বয়ংসম্পূর্ণ SQL ডাটাবেস ইঞ্জিন প্রয়োগ করে।",
    db_mariadb_description: "MariaDB হল MySQL-এর একটি কমিউনিটি-উন্নত, বাণিজ্যিকভাবে সমর্থিত ফর্ক।",
    db_transactsql_description: "Microsoft SQL Server হল Microsoft দ্বারা উন্নত একটি রিলেশনাল ডাটাবেস ম্যানেজমেন্ট সিস্টেম।",
    db_oraclesql_description: "Oracle Database হল Oracle Corporation দ্বারা উৎপাদিত একটি মাল্টি-মডেল ডাটাবেস ম্যানেজমেন্ট সিস্টেম।",
    enums: "এনামস",
