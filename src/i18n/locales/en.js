...
const en = {
  translation: {
    ...
    enums: "Enums",
    add_enum: "Add enum",
    add_base_table: "Add base table",
    base_tables: "Base tables",
    no_base_tables: "No base tables",
    no_base_tables_text: "Create base tables to define common fields",
    inherit_from_base_table: "Inherit from base table",
    inherit_from: "Inherit from",
    select_base_table: "Select base table",
    field_conflict_warning:
      "Fields '{{fields}}' already exist in this table. Your table's fields were kept, and these fields from '{{baseTableName}}' were skipped.",
    base_table_deleted: "Base table deleted",
    delete_base_table: "Delete base table {{baseTableName}}",
    edit_base_table: "Edit base table {{baseTableName}}{{extra}}",
