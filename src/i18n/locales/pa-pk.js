...
const pa_pk = {
  ...
  "import": "منگاؤ",
  "inherits": "وراثت",
  "merging_column_w_inherited_definition": "ٹیبل '{{tableName}}' وچ کالم '{{fieldName}}' وراثت دی تعریف نال رلا دتا جاوے گا",
  ...
  "are_you_sure_delete_diagram": "تُسی پکا ایہہ ڈایاگرام مٹانا چاہندے او؟ ایہہ کم واپس نہیں ہو سکدا۔",
  ...
  "are_you_sure_flush_storage": "تُسی پکا سٹوریج صاف کرنا چاہندے او؟ ایہہ تہاڈے سارے ڈایاگرام تے کسٹم ٹیمپلیٹ ہمیشہ لئی مٹا دے گا۔",
  ...
  "upload_sql_to_generate_diagrams": "اپنے ٹیبل تے کالم آپے بناون لئی sql فائل اپ لوڈ کرو۔",
  ...
  "no_values_for_field": "'{{tableName}}' ٹیبل دا فیلڈ '{{fieldName}}' `{{type}}` قسم دا اے پر کوئی ویلیو نہیں دتی گئی",
  "default_doesnt_match_type": "ٹیبل '{{tableName}}' وچ فیلڈ '{{fieldName}}' دی ڈیفالٹ ویلیو اس دی قسم نال نہیں ملدی",
  "not_null_is_null": "ٹیبل '{{tableName}}' دا فیلڈ '{{fieldName}}' NOT NULL اے پر اس دا ڈیفالٹ NULL اے",
  "duplicate_fields": "ٹیبل '{{tableName}}' وچ '{{fieldName}}' ناں نال ڈپلیکیٹ فیلڈز",
  "duplicate_index": "ٹیبل '{{tableName}}' وچ '{{indexName}}' ناں نال ڈپلیکیٹ انڈیکس",
  ...
  "no_values_for_type_field": "قسم '{{typeName}}' دا فیلڈ '{{fieldName}}' `{{type}}` قسم دا اے پر کوئی ویلیو نہیں دتی گئی",
  "duplicate_type_fields": "قسم '{{typeName}}' وچ '{{fieldName}}' ناں نال ڈپلیکیٹ ٹائپ فیلڈز",
  ...
  "generic": "عام",
  "generic_description": "عام ڈایاگرام کسے وی SQL ذائقے وچ برآمد کیتے جا سکدے نیں پر کچھ ڈیٹا دی قسماں دی حمایت کردے نیں۔",
  "enums": "Enums",
  ...
  "empty_index_name": "ٹیبل '{{tableName}}' وچ بغیر ناں دے انڈیکس دا اعلان کیتا",
  ...
  "share_info": "* اس لنک نوں شیئر کرن نال لائیو ریئل ٹائم تعاون دا سیشن نہیں بنے گا۔",
  ...
  "restore_warning": "دوجا ورژن لوڈ کرن نال کوئی وی تبدیلیاں اوور رائٹ ہو جان گیاں۔",
